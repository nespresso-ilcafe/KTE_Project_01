...
//디비 입력
String sql = "INSERT INTO "+code+" (id, name, subject, comment, signdate, ref, gongji, file1, file1_o, file1_s, trade, price)";
	//DB의 칼럼명들과 1:1매칭 시켜주기 위함
sql = sql + " VALUES ('"+session_id+"', '"+session_name+"', '"+subject+"', '"+comment+"', '"+signdate+"', 0, '"+gongji+"','"+file1_rename+"','"+file1_name+"','"+file1_thumb+"','"+trade+"','"+price+"')";
